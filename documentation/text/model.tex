...
The code is pseudo-spectral, Chebyshev-decomposed in the vertical direction and Fourier-decomposed in the horizontal.
	...
	% subsection diffusion (end)

	\subsection{Implicit Solve} % (fold)
	\label{sub:solve}
		...
		The horizontal solve takes the following form:
			\begin{equation}
		...
		\subsubsection{Time Stepping} % (fold)
		...
		% subsubsection time_stepping (end)

	% subsection solve (end)

	\subsection{Parallelization} % (fold)
