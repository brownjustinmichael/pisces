...
namespace plans
{
	namespace solvers
	{
		...
		laplace <datatype>::laplace (grids::grid <datatype> &i_grid_n, grids::grid <datatype> &i_grid_m, mpi::messenger* i_messenger_ptr, datatype *i_rhs, datatype* i_data, int *i_element_flags, int *i_component_flags) : 
		...
		template <class datatype>
		void laplace <datatype>::factorize () {
