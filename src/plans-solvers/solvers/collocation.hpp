...
namespace plans
{
	namespace solvers
	{
		...
		void init (mpi::messenger* i_messenger_ptr, datatype& i_timestep, std::shared_ptr <boundaries::boundary <datatype>> i_boundary_0, std::shared_ptr <boundaries::boundary <datatype>> i_boundary_n, datatype *i_rhs, grids::variable &i_data, grids::variable &i_data_out);
		...
		public:
			 ...
			 ************************************************************************/
			collocation (mpi::messenger* i_messenger_ptr, datatype& i_timestep, std::shared_ptr <boundaries::boundary <datatype>> i_boundary_0, std::shared_ptr <boundaries::boundary <datatype>> i_boundary_n, datatype *i_rhs, grids::variable &i_data, grids::variable &i_data_out) :
			 ...
			 * \param i_data_out A reference to the data to update
			 ************************************************************************/
			collocation (mpi::messenger* i_messenger_ptr, datatype& i_timestep, typename boundaries::boundary <datatype>::factory &i_boundary_0, typename boundaries::boundary <datatype>::factory &i_boundary_n, datatype *i_rhs, grids::variable &i_data, grids::variable &i_data_out) :
			solver <datatype> (i_data, i_data_out, this->get_state_in (), this->get_state ()),
			timestep (i_timestep) {
