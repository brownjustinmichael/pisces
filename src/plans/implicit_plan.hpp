...
namespace plans
{
	...
	public:
		 ...
		 ************************************************************************/
		implicit_plan (datatype *i_matrix_n, datatype *i_matrix_m, grids::variable <datatype> &i_data_in, grids::variable <datatype> &i_data_out = NULL, datatype i_coeff = 1.0) :
		plans::plan <datatype> (i_data_in, i_data_out, spectral_spectral, real_spectral, i_coeff), 
		matrix_n (i_matrix_n), 
		matrix_m (i_matrix_m), 
