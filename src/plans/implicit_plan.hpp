...
namespace plans
{
	...
	public:
		...
		plans::plan <datatype> (i_element_flags, i_component_flags, i_coeff), matrix_n (i_matrix_n), matrix_m (i_matrix_m), n (i_data_in.get_grid (0).get_n ()), ldn (i_data_in.get_grid (0).get_ld ()), m (i_data_in.get_grid (1).get_n ()), grid_n (i_data_in.get_grid (0)), grid_m (i_data_in.get_grid (1)), data_in (i_data_in.ptr ()), data_out (i_data_out ? i_data_out : i_data_in.ptr ()) {}
