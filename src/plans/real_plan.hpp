...
namespace plans
{
	...
	public:
		 ...
		 ************************************************************************/
		real_plan (grids::variable &i_data_in, grids::variable &i_data_out, double i_coeff = 1.0) : 
		plans::plan (i_data_in, i_data_out, real_real, real_real, i_coeff), 
