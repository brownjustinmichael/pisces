...
namespace plans
{
	...
	{
		template <>
		horizontal <float>::horizontal (int n, int m, float* i_data_in, float* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		...
		template <>
		horizontal <float>::horizontal (grids::grid <float> &i_grid_n, grids::grid <float> &i_grid_m, float* i_data_in, float* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		plans::plan <float> (i_element_flags, i_component_flags),
		n (i_grid_n.get_n ()), 
		m (i_grid_m.get_n ()), 
		data_in (i_data_in),
		...
		template <>
		horizontal <double>::horizontal (int n, int m, double* i_data_in, double* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		...
		template <>
		horizontal <double>::horizontal (grids::grid <double> &i_grid_n, grids::grid <double> &i_grid_m, double* i_data_in, double* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		plans::plan <double> (i_element_flags, i_component_flags),
		n (i_grid_n.get_n ()), 
		m (i_grid_m.get_n ()), 
		data_in (i_data_in),
	...
	// #pragma omp parallel for num_threads (threads)
		...
		template <>
		vertical <float>::vertical (int n, int m, float* i_data_in, float* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		plans::plan <float> (i_element_flags, i_component_flags),
		n (n), 
		m (m), 
		data_in (i_data_in),
		...
		template <>
		vertical <float>::vertical (grids::grid <float> &i_grid_n, grids::grid <float> &i_grid_m, float* i_data_in, float* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		plans::plan <float> (i_element_flags, i_component_flags),
		n (i_grid_n.get_n ()), 
		m (i_grid_m.get_n ()), 
		data_in (i_data_in),
		...
		template <>
		vertical <double>::vertical (int n, int m, double* i_data_in, double* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		plans::plan <double> (i_element_flags, i_component_flags),
		n (n), 
		m (m), 
		data_in (i_data_in),
		...
		template <>
		vertical <double>::vertical (grids::grid <double> &i_grid_n, grids::grid <double> &i_grid_m, double* i_data_in, double* i_data_out, int i_flags, int *i_element_flags, int *i_component_flags, int i_threads) :
		plans::plan <double> (i_element_flags, i_component_flags),
		n (i_grid_n.get_n ()), 
		m (i_grid_m.get_n ()), 
		data_in (i_data_in),
