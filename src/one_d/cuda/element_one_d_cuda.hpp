...
namespace cuda
{
	namespace one_d
	{
		namespace chebyshev
		{
			...
			{
			public:
				fft_element (int i_n, int i_excess_0, datatype i_position_0, int i_excess_n, datatype i_position_n, int i_name, io::parameters& i_input_Params, utils::messenger* i_messenger_ptr, int i_flags);
