...
namespace one_d
{
	...
	public:
		 ...
		 * \copydoc plan::plan ()
		 *********************************************************************/
		implicit_plan (int i_n, bases::collocation_grid <datatype>* i_grid, datatype* i_data_in, datatype *i_matrix, datatype* i_data_out) :
	...
	protected:
		bases::collocation_grid <datatype>* grid; //!< A shared pointer to the grid
