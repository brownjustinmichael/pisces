...
namespace one_d
{
	...
	public:
		 ...
		 *********************************************************************/
		solver (bases::messenger* i_messenger_ptr, int i_n, int i_excess_0, int i_excess_n, int i_n_iterations, datatype& i_timestep, datatype& i_alpha_0, datatype& i_alpha_n, datatype* positions, datatype *i_default_matrix, datatype *i_matrix, datatype* i_data_in, datatype* i_explicit_rhs, datatype* i_implicit_rhs, datatype* i_data_out = NULL, int i_flags = 0x00);
