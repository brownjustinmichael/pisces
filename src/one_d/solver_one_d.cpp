...
namespace one_d
{
	...
	void solver <datatype>::_solve () {
		...
		if (ntop != 0) {
			utils::interpolate (ex_excess_0, 1, n - excess_0 - excess_n, 1.0, positions + excess_0, &data_temp [ex_excess_0 + ntop + excess_0], &positions_0 [0], &data_temp [ntop], lda, lda);
		...
		if (nbot != 0) {
			utils::interpolate (ex_excess_n, 1, n - excess_0 - excess_n, 1.0, positions + excess_0, &data_temp [ex_excess_0 + ntop + excess_0], &positions_n [0], &data_temp [lda - nbot - ex_excess_n], lda, lda);
		...
		utils::interpolate (ex_excess_0, 1, n, 1.0, positions, data, &positions_0 [0], &data_temp [1], n, lda);
		utils::interpolate (ex_excess_n, 1, n, 1.0, positions, data, &positions_n [0], &data_temp [lda - 1 - ex_excess_n], n, lda);
