...
namespace utils
{
	...
	void tridiagonal_direct_solve (int n, float *dl, float *d, float *du, float *du2, float *b, int nrhs = 1, int ldb = -1);
	void tridiagonal_direct_solve (int n, double *dl, double *d, double *du, double *du2, double *b, int nrhs = 1, int ldb = -1);
